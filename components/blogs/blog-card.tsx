            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4">
                            ...
                            >
                                <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300 h-full">
                                    ...
                                    <CardContent className="p-6">
                                        <p className="text-[#0C708E] text-sm font-medium mb-2">{post.date}</p>
                                        <h3 className="text-xl font-semibold text-black mb-3 line-clamp-2">{post.title}</h3>
                                        <p className="text-gray-600 text-sm mb-4 line-clamp-3">{post.excerpt}</p>
                                        <Button
                                            variant="link"
                                            className="text-[#0C708E] hover:text-[#08596F] p-0 font-medium"
                    ...
                    <div className="flex justify-center items-center space-x-2">
                        ...
                        <Button
                            size="sm"
                            className="bg-[#0C708E] hover:bg-[#08596F] text-white"
                            aria-current="page"
                        >
                            1
                        </Button>
