...
export function WhatsAppFloatingButton() {
  ...
  return (
    <>
      ...
      >
        <motion.div
          className="fixed top-1/2 right-0 z-50 flex items-center rounded-l-full bg-[#0C708E] shadow-lg cursor-pointer overflow-hidden"
        ...
        >
          <motion.div
            className="w-14 h-12 ml-4 flex justify-center items-center rounded-l-full bg-[#0C708E]"
            initial={{ scale: 1 }}
