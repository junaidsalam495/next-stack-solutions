        ...
        >
            ...
            <div className="relative z-20 h-full flex flex-col justify-between p-6 text-white">
                <div className="space-y-2">
                    <Skeleton className="h-4 w-24 rounded-full bg-[#0C708E]/30" />
                    <Skeleton className="h-6 w-3/4 rounded bg-white/30" />
                </div>
                <Skeleton className="h-10 w-32 rounded-full bg-[#0C708E]/30 mt-4" />
            </div>
        </div>
    ));
        ...
        <>
                            ...
                            <Card className="group relative h-72 overflow-hidden rounded-xl shadow-lg">
                                ...
                                <CardContent className="relative z-20 h-full flex flex-col justify-between p-6 text-white">
                                    ...
                                    <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        <Button className="bg-[#0C708E] hover:bg-[#08596F] text-white rounded-full px-5 flex items-center gap-2">
            ...
            <div className="text-center mt-12">
                <Button
                    ...
                    className="bg-[#0C708E] hover:bg-[#08596F] text-white rounded-full px-8"
                >
