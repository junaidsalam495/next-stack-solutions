                ...
                <div className="container mx-auto px-4">
                    ...
                    <Tabs defaultValue="logos" className="w-full">
                        <TabsList className="flex justify-center mb-12 w-64 items-center mx-auto">
                            <TabsTrigger
                                value="logos"
                                className="px-6 py-3 w-36 font-medium data-[state=active]:text-[#0C708E] data-[state=active]:border-b-2 border-[#0C708E] text-gray-600 hover:text-[#0C708E] transition"
                            >
                                Logos
                            </TabsTrigger>
                            <TabsTrigger
