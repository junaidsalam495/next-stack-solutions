                    ...
                    <div className="bg-black/50 rounded-3xl w-full h-full flex flex-col items-start justify-between p-8 text-white">
                        <div className="mt-12 ml-12">
                            ...
                            <h3
                                ...
                                style={{ backgroundImage: "linear-gradient(to right, #0C708E, #08596F)" }}
                            >
                        ...
                        <div className="w-full text-center">
                            <Link
                                ...
                                className="inline-block mt-6 px-6 py-2 bg-[#0C708E] hover:bg-[#08596F] text-white font-medium rounded-full transition w-full text-center shadow focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2"
                            >
                                View Case Study
                            </Link>
                        </div>
