            ...
            >
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    <TabsList className="grid w-full grid-cols-3 bg-gray-100 border border-gray-200 rounded-2xl p-2 mb-8 h-16">
                        <TabsTrigger
                            value="overview"
                            className="flex items-center gap-3 data-[state=active]:bg-[#0C708E] data-[state=active]:text-white text-gray-600 rounded-xl transition-all duration-300 h-12 text-base font-medium"
                        >
