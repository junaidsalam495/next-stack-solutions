  ...
  return (
    <section className="relative min-h-screen flex flex-col items-start justify-center bg-black px-4 md:px-12 overflow-hidden">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="relative z-10 bg-[#0C708E] hover:bg-[#08596F] text-white rounded-full px-8 py-3 font-semibold flex items-center justify-center gap-3 shadow-md focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2"
